...
if ( ! $nv_Request->isset_request( 'id', 'post,get' ) )
{
	...
	if( ! empty( $q ) )
	{
		$db->where( 'name LIKE :q_name OR year LIKE :q_year OR email LIKE :q_email OR phone LIKE :q_phone OR sex LIKE :q_sex OR address LIKE :q_address OR status LIKE :q_status' );
	}
