...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2017 at 07:42 PM
...
(1, 'ckeditor', 1, 'adobe,archives,audio,documents,flash,images,real,video|1|1|1', 'Administrator', 0, 0, 0, '', '28b65bf3068fd83a8d617690479769cc', 1494063980, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.96 Safari/537.36');
...
(1, 'siteinfo', 'mod_siteinfo', 1, 1, 1, 1, 'd8f09c019cde7986b4092c10dd115781'),
(2, 'authors', 'mod_authors', 2, 1, 1, 1, 'd6464b0651943b2e29c491ef9acd0990'),
(3, 'settings', 'mod_settings', 3, 1, 1, 0, '65ed2e70829826c3c0dd792c0a50dc2d'),
(4, 'database', 'mod_database', 4, 1, 0, 0, 'de88df994d725d846d27a4db454f9207'),
(5, 'webtools', 'mod_webtools', 5, 1, 0, 0, '4f71af58ec317289437e85fd634c5a32'),
(6, 'seotools', 'mod_seotools', 6, 1, 1, 0, 'd9761cb0f8561528b1ae970eb7467add'),
(7, 'language', 'mod_language', 7, 1, 1, 0, '389ecb9ac1883c8ae45af2bcef9edfe1'),
(8, 'modules', 'mod_modules', 8, 1, 1, 0, '4e38be44c6dbd28ce42b8f454ccdc9e5'),
(9, 'themes', 'mod_themes', 9, 1, 1, 0, '06952d249308228b881064df7f3ea0a7'),
(10, 'extensions', 'mod_extensions', 10, 1, 0, 0, 'f10582b0c80042a044a5c9c19694fc57'),
(11, 'upload', 'mod_upload', 11, 1, 1, 1, 'b1977b1f91f02b4eba7ef3a4500c2858');
...
(2, 'vinades', 2, 0, 'vinades.jpg', 'jpg', 'image/jpeg', 212, 400, '', '', 'http://vinades.vn', '_blank', '', 1494063912, 1494063912, 0, 0, 1, 2),
(3, 'Quang cao giua trang', 1, 0, 'webnhanh.jpg', 'png', 'image/jpeg', 575, 72, '', '', 'http://webnhanh.vn', '_blank', '', 1494063912, 1494063912, 0, 0, 1, 1);
...
('vi', 'global', 'cronjobs_next_time', '1494070343'),
...
('sys', 'site', 'site_email', 'thuvp95@gmail.com'),
('sys', 'global', 'error_set_logs', '1'),
('sys', 'global', 'error_send_email', 'thuvp95@gmail.com'),
('sys', 'global', 'site_lang', 'vi'),
('sys', 'global', 'my_domains', 'khambenh.my'),
('sys', 'global', 'cookie_prefix', 'nv4c_s25ou'),
('sys', 'global', 'session_prefix', 'nv4s_q25158'),
...
('sys', 'global', 'ftp_user_pass', 'Y4nglf7cLbNxsaFLwfR962OJ4JX-3C2zcbGhS8H0fes,'),
('sys', 'global', 'ftp_path', '/'),
...
('c_time', 'start', 0, 0, 0),
('c_time', 'last', 0, 1494070046, 0),
('total', 'hits', 1494070046, 4, 4),
('year', '2017', 1494070046, 4, 4),
('year', '2018', 0, 0, 0),
('year', '2019', 0, 0, 0),
('year', '2020', 0, 0, 0),
('year', '2021', 0, 0, 0),
...
('dayofweek', 'Saturday', 1494070046, 4, 4),
('hour', '00', 0, 0, 0),
('hour', '01', 0, 0, 0),
('hour', '02', 0, 0, 0),
('hour', '03', 0, 0, 0),
...
('hour', '14', 0, 0, 0),
('hour', '15', 0, 0, 0),
('hour', '16', 1494063990, 1, 1),
('hour', '17', 1494068241, 2, 2),
('hour', '18', 1494070046, 1, 1),
('hour', '19', 0, 0, 0),
('hour', '20', 0, 0, 0),
('hour', '21', 0, 0, 0),
('hour', '22', 0, 0, 0),
...
(1, 1494063912, 5, 'online_expired_del.php', 'cron_online_expired_del', '', 0, 1, 1, 1494070043, 1, 'Xóa các dòng ghi trạng thái online đã cũ trong CSDL'),
(2, 1494063912, 1440, 'dump_autobackup.php', 'cron_dump_autobackup', '', 0, 1, 1, 1494063974, 1, 'Tự động lưu CSDL'),
(3, 1494063912, 60, 'temp_download_destroy.php', 'cron_auto_del_temp_download', '', 0, 1, 1, 1494068244, 1, 'Xóa các file tạm trong thư mục tmp'),
(4, 1494063912, 30, 'ip_logs_destroy.php', 'cron_del_ip_logs', '', 0, 1, 1, 1494068244, 1, 'Xóa IP log files, Xóa các file nhật ký truy cập'),
(5, 1494063912, 1440, 'error_log_destroy.php', 'cron_auto_del_error_log', '', 0, 1, 1, 1494063974, 1, 'Xóa các file error_log quá hạn'),
(6, 1494063912, 360, 'error_log_sendmail.php', 'cron_auto_sendmail_error_log', '', 0, 1, 0, 0, 0, 'Gửi email các thông báo lỗi cho admin'),
(7, 1494063912, 60, 'ref_expired_del.php', 'cron_ref_expired_del', '', 0, 1, 1, 1494068244, 1, 'Xóa các referer quá hạn'),
(8, 1494063912, 60, 'check_version.php', 'cron_auto_check_version', '', 0, 1, 1, 1494068244, 1, 'Kiểm tra phiên bản NukeViet'),
(9, 1494063912, 1440, 'notification_autodel.php', 'cron_notification_autodel', '', 0, 1, 1, 1494063974, 1, 'Xóa thông báo cũ');
...
(1, 'vi', 'login', '[admin] Đăng nhập', ' Client IP:127.0.0.1', '', 0, 1494063980),
(2, 'vi', 'modules', 'Thiết lập module mới nvtools', '', '', 1, 1494064010),
(3, 'vi', 'modules', 'Sửa module &ldquo;nvtools&rdquo;', '', '', 1, 1494064030),
(4, 'vi', 'modules', 'Cài lại module "nvtools"', '', '', 1, 1494064045),
(5, 'vi', 'modules', 'Sửa module &ldquo;nvtools&rdquo;', '', '', 1, 1494064058),
(6, 'vi', 'themes', 'Sửa block', 'Name : Menu Site', '', 1, 1494064145),
(7, 'vi', 'modules', 'Cài lại module "nvtools"', '', '', 1, 1494064518),
(8, 'vi', 'login', '[admin] Thoát khỏi tài khoản Quản trị', ' Client IP:127.0.0.1', '', 0, 1494070043);
...
('an4baeijhtm24jm47gj1hiqf01', 0, 'guest', 1494070049);
...
(0, 'module', 'about', 0, 0, 'page', 'about', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(0, 'module', 'siteterms', 0, 0, 'page', 'siteterms', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(19, 'module', 'banners', 1, 0, 'banners', 'banners', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(20, 'module', 'contact', 0, 1, 'contact', 'contact', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(1, 'module', 'news', 0, 1, 'news', 'news', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(21, 'module', 'voting', 0, 0, 'voting', 'voting', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(0, 'module', 'nvtools', 0, 0, 'nvtools', 'nvtools', '4.0.24 1446612645', 1494064007, 'VINADES (contact@vinades.vn)', 'Công cụ xây dựng site'),
(284, 'module', 'seek', 1, 0, 'seek', 'seek', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(24, 'module', 'users', 1, 1, 'users', 'users', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(27, 'module', 'statistics', 0, 0, 'statistics', 'statistics', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(29, 'module', 'menu', 0, 0, 'menu', 'menu', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(283, 'module', 'feeds', 1, 0, 'feeds', 'feeds', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(282, 'module', 'page', 1, 1, 'page', 'page', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(281, 'module', 'comment', 1, 0, 'comment', 'comment', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(312, 'module', 'freecontent', 0, 1, 'freecontent', 'freecontent', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(327, 'module', 'two-step-verification', 1, 0, 'two-step-verification', 'two_step_verification', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(307, 'theme', 'default', 0, 0, 'default', 'default', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', ''),
(311, 'theme', 'mobile_default', 0, 0, 'mobile_default', 'mobile_default', '4.1.01 1491752500', 1494063912, 'VINADES (contact@vinades.vn)', '');
...
(0, '', 0, 3, 100, 150, 90),
(1, 'uploads/news', 0, 0, 0, 0, 0),
(2, 'uploads/news/source', 0, 0, 0, 0, 0),
(3, 'uploads/news/temp_pic', 0, 0, 0, 0, 0),
(4, 'uploads/news/topics', 0, 0, 0, 0, 0),
(5, 'uploads/menu', 0, 0, 0, 0, 0),
(6, 'uploads', 0, 0, 0, 0, 0),
(7, 'uploads/about', 0, 0, 0, 0, 0),
(8, 'uploads/banners', 0, 0, 0, 0, 0),
(9, 'uploads/contact', 0, 0, 0, 0, 0),
(10, 'uploads/freecontent', 0, 0, 0, 0, 0),
(11, 'uploads/page', 0, 0, 0, 0, 0),
(12, 'uploads/siteterms', 0, 0, 0, 0, 0),
(13, 'uploads/users', 0, 0, 0, 0, 0),
(14, 'uploads/users/groups', 0, 0, 0, 0, 0),
(15, 'uploads/nvtools', 0, 0, 0, 0, 0),
(16, 'uploads/nvtools/compiler', 0, 0, 0, 0, 0);
...
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '{SSHA512}dN/TlNAcyxyOiVCCpncLigb8txMWg+qf7FGehCgisSH0X5GQD367V5YMt3M8pWWFYS2xbV9KAU+nP3GEXQDeqjZlMTc=', 'thuvp95@gmail.com', 'admin', '', '', '', 0, '', 1494063964, 'a?', 'b', '', 0, 1, '1', 1, 0, '', '', 1494063964, '', '', '', 0, 0, '');
...
CREATE TABLE IF NOT EXISTS `nv4_users_backupcodes` (
`userid` mediumint(8) unsigned NOT NULL,
...
(1, 'Super admin', '', 'Super Admin', '', 0, '', '', 0, 1494063912, 0, 1, 1, 0, 1, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(2, 'General admin', '', 'General Admin', '', 0, '', '', 0, 1494063912, 0, 2, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(3, 'Module admin', '', 'Module Admin', '', 0, '', '', 0, 1494063912, 0, 3, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(4, 'Users', '', 'Users', '', 0, '', '', 0, 1494063912, 0, 4, 1, 0, 1, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(7, 'New Users', '', 'New Users', '', 0, '', '', 0, 1494063912, 0, 5, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(5, 'Guest', '', 'Guest', '', 0, '', '', 0, 1494063912, 0, 6, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(6, 'All', '', 'All', '', 0, '', '', 0, 1494063912, 0, 7, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(10, 'NukeViet-Fans', '', 'Nhóm những người hâm mộ hệ thống NukeViet', '', 2, '', '', 1, 1494063912, 0, 8, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(11, 'NukeViet-Admins', '', 'Nhóm những người quản lý website xây dựng bằng hệ thống NukeViet', '', 2, '', '', 0, 1494063912, 0, 9, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}'),
(12, 'NukeViet-Programmers', '', 'Nhóm Lập trình viên hệ thống NukeViet', '', 1, '', '', 0, 1494063912, 0, 10, 1, 0, 0, 0, 'a:7:{s:17:"access_groups_add";i:1;s:17:"access_groups_del";i:1;s:12:"access_addus";i:0;s:14:"access_waiting";i:0;s:13:"access_editus";i:0;s:12:"access_delus";i:0;s:13:"access_passus";i:0;}');
...
--
-- Table structure for table `nv4_vi_kham_benh_drug`
--

CREATE TABLE IF NOT EXISTS `nv4_vi_kham_benh_drug` (
`id` int(11) unsigned NOT NULL,
...
--
-- Table structure for table `nv4_vi_kham_benh_history`
--

CREATE TABLE IF NOT EXISTS `nv4_vi_kham_benh_history` (
`id` int(11) unsigned NOT NULL,
...
--
-- Table structure for table `nv4_vi_kham_benh_patient`
--

CREATE TABLE IF NOT EXISTS `nv4_vi_kham_benh_patient` (
`id` int(11) unsigned NOT NULL,
...
(64, 'action', 'action', 'Action', '', 'nvtools', 1, 1, 5, ''),
(65, 'addfun', 'addfun', 'Addfun', '', 'nvtools', 1, 1, 4, ''),
(66, 'block', 'block', 'Block', '', 'nvtools', 1, 1, 7, ''),
(67, 'checktable', 'checktable', 'Checktable', '', 'nvtools', 0, 0, 0, ''),
(68, 'compiler', 'compiler', 'Compiler', '', 'nvtools', 1, 1, 10, ''),
(69, 'copylang', 'copylang', 'Copylang', '', 'nvtools', 1, 1, 11, ''),
(70, 'data', 'data', 'Data', '', 'nvtools', 1, 1, 3, ''),
(71, 'export_excel', 'export_excel', 'Export_excel', '', 'nvtools', 1, 1, 6, ''),
(72, 'js', 'js', 'Js', '', 'nvtools', 0, 0, 0, ''),
(73, 'main', 'main', 'Main', '', 'nvtools', 1, 1, 1, ''),
(74, 'theme', 'theme', 'Theme', '', 'nvtools', 1, 1, 2, ''),
(75, 'themecopy', 'themecopy', 'Themecopy', '', 'nvtools', 1, 1, 8, ''),
(76, 'thememodulecp', 'thememodulecp', 'Thememodulecp', '', 'nvtools', 1, 1, 9, '');
...
INSERT INTO `nv4_vi_modules` (`title`, `module_file`, `module_data`, `module_upload`, `module_theme`, `custom_title`, `site_title`, `admin_title`, `set_time`, `main_file`, `admin_file`, `theme`, `mobile`, `description`, `keywords`, `groups_view`, `weight`, `act`, `admins`, `rss`, `gid`) VALUES
('about', 'page', 'about', 'about', 'page', 'Giới thiệu', '', '', 1494063912, 1, 1, '', '', '', '', '6', 1, 1, '', 1, 0),
('news', 'news', 'news', 'news', 'news', 'Tin Tức', '', '', 1494063912, 1, 1, '', '', '', '', '6', 2, 1, '', 1, 0),
('users', 'users', 'users', 'users', 'users', 'Thành viên', '', 'Tài khoản', 1494063912, 1, 1, '', '', '', '', '6', 3, 1, '', 0, 0),
('contact', 'contact', 'contact', 'contact', 'contact', 'Liên hệ', '', '', 1494063912, 1, 1, '', '', '', '', '6', 4, 1, '', 0, 0),
('statistics', 'statistics', 'statistics', 'statistics', 'statistics', 'Thống kê', '', '', 1494063912, 1, 1, '', '', '', 'online, statistics', '6', 5, 1, '', 0, 0),
('voting', 'voting', 'voting', 'voting', 'voting', 'Thăm dò ý kiến', '', '', 1494063912, 1, 1, '', '', '', '', '6', 6, 1, '', 1, 0),
('banners', 'banners', 'banners', 'banners', 'banners', 'Quảng cáo', '', '', 1494063912, 1, 1, '', '', '', '', '6', 7, 1, '', 0, 0),
('seek', 'seek', 'seek', 'seek', 'seek', 'Tìm kiếm', '', '', 1494063912, 1, 0, '', '', '', '', '6', 8, 1, '', 0, 0),
('menu', 'menu', 'menu', 'menu', 'menu', 'Menu Site', '', '', 1494063912, 0, 1, '', '', '', '', '6', 9, 1, '', 0, 0),
('feeds', 'feeds', 'feeds', 'feeds', 'feeds', 'RSS-feeds', '', 'RSS-feeds', 1494063912, 1, 1, '', '', '', '', '6', 10, 1, '', 0, 0),
('page', 'page', 'page', 'page', 'page', 'Page', '', '', 1494063912, 1, 1, '', '', '', '', '6', 11, 1, '', 1, 0),
('comment', 'comment', 'comment', 'comment', 'comment', 'Bình luận', '', 'Quản lý bình luận', 1494063912, 0, 1, '', '', '', '', '6', 12, 1, '', 0, 0),
('siteterms', 'page', 'siteterms', 'siteterms', 'page', 'Điều khoản sử dụng', '', '', 1494063912, 1, 1, '', '', '', '', '6', 13, 1, '', 1, 0),
('freecontent', 'freecontent', 'freecontent', 'freecontent', 'freecontent', 'Giới thiệu sản phẩm', '', '', 1494063912, 0, 1, '', '', '', '', '6', 14, 1, '', 0, 0),
('two-step-verification', 'two-step-verification', 'two_step_verification', 'two_step_verification', 'two-step-verification', 'Xác thực hai bước', '', '', 1494063912, 1, 0, '', '', '', '', '6', 15, 1, '', 0, 0),
('nvtools', 'nvtools', 'nvtools', 'nvtools', 'nvtools', 'nvtools', '', 'nvtools', 1494064010, 1, 0, '', '', '', '', '6', 16, 1, '', 0, 0);
...
(9, 11, '11', 0, 1, 'Phạm Quốc Tiến', 0, 1445391090, 1445394193, 1, 1445391060, 0, 2, 'Tuyển dụng lập trình viên front-end (HTML/CSS/JS) phát triển NukeViet', 'Tuyen-dung-lap-trinh-vien-front-end-HTML-CSS-JS', 'Bạn đam mê nguồn mở? Bạn đang cần tìm một công việc phù hợp với thế mạnh của bạn về front-end (HTML/CSS/JS)?. Hãy gia nhập VINADES.,JSC để xây dựng mã nguồn mở hàng đầu cho Việt Nam.', '', 'Tuyển dụng', 0, 1, '6', 1, 0, 0, 0, 0, 0, 0, '', 0),
...
--
-- Indexes for table `nv4_vi_kham_benh_doctor`
--
ALTER TABLE `nv4_vi_kham_benh_doctor`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `nv4_vi_kham_benh_drug`
--
ALTER TABLE `nv4_vi_kham_benh_drug`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `nv4_vi_kham_benh_history`
--
ALTER TABLE `nv4_vi_kham_benh_history`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `nv4_vi_kham_benh_patient`
--
ALTER TABLE `nv4_vi_kham_benh_patient`
 ADD PRIMARY KEY (`id`);
...
ALTER TABLE `nv4_vi_news_1`
 ADD PRIMARY KEY (`id`), ADD KEY `catid` (`catid`), ADD KEY `topicid` (`topicid`), ADD KEY `admin_id` (`admin_id`), ADD KEY `author` (`author`), ADD KEY `title` (`title`), ADD KEY `addtime` (`addtime`), ADD KEY `edittime` (`edittime`), ADD KEY `publtime` (`publtime`), ADD KEY `exptime` (`exptime`), ADD KEY `status` (`status`), ADD KEY `instant_active` (`instant_active`), ADD KEY `instant_creatauto` (`instant_creatauto`);
...
--
-- AUTO_INCREMENT for table `nv4_vi_kham_benh_doctor`
--
ALTER TABLE `nv4_vi_kham_benh_doctor`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nv4_vi_kham_benh_drug`
--
ALTER TABLE `nv4_vi_kham_benh_drug`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nv4_vi_kham_benh_history`
--
ALTER TABLE `nv4_vi_kham_benh_history`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `nv4_vi_kham_benh_patient`
--
ALTER TABLE `nv4_vi_kham_benh_patient`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `nv4_vi_menu_rows`
MODIFY `id` mediumint(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `nv4_vi_modfuncs`
--
ALTER TABLE `nv4_vi_modfuncs`
MODIFY `func_id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=77;
--
